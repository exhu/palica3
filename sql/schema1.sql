...
BEGIN TRANSACTION;
CREATE TABLE app_info(info_key TEXT UNIQUE, info_value TEXT);
...
BEGIN TRANSACTION;
CREATE TABLE settings(setting_key TEXT UNIQUE, setting_value TEXT);
...
BEGIN TRANSACTION;
CREATE TABLE glob_patterns(id INTEGER PRIMARY KEY, regexp TEXT);
...
BEGIN TRANSACTION;
CREATE TABLE exclude_globs(id INTEGER PRIMARY KEY, glob_pattern_id INTEGER UNIQUE);
...
CREATE TABLE include_globs(id INTEGER PRIMARY KEY, glob_pattern_id INTEGER UNIQUE);
