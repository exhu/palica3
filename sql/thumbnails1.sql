...
INSERT INTO app_info VALUES('max_size_x', '256');
INSERT INTO app_info VALUES('max_size_y', '256');
-- command line tool
-- [^{]\{input\}[^}]
-- [^{]\{output\}[^}]
INSERT INTO app_info VALUES('cmd_line', 'cjxl -j 0 {input} {output}');
...
CREATE TABLE src_item(id INTEGER PRIMARY KEY, fs_path TEXT UNIQUE NOT NULL,
    hash_value TEXT NOT NULL, fs_mod_time INTEGER NOT NULL);
...
CREATE TABLE src_to_thumbnail(src_item_id INTEGER UNIQUE NOT NULL,
    thumbnail_blob_id INTEGER UNIQUE NOT NULL);
